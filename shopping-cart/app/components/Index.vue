<script>
  import { changePrice, changeStyle } from '../vuex/actions' 
          ...
          <div class="detail col-md-6 col-sm-6">
            ...
            <div class="options">
              ...
              <dl class="option dl-horizontal">
                ...
                <dd>
                  <ul>
                    <li v-for="price in iPhone6S.store"
            ...
            <hr>
            <button class="btn btn-danger btn-block"><span class="glyphicon glyphicon-shopping-cart"></span> 加入购物车</button>
          </div>
        </div>
      </div> <!-- ./product -->
      <div class="cart col-md-4 col-sm-4">
        <div class="panel panel-success">
          <div class="panel-heading"><span class="glyphicon glyphicon-shopping-cart"></span> 购物车<span class="pull-right">总计：</span></div>
          <div class="panel-body">
            <div class="cart-title">
              <span>Apple/苹果 IPhone 6S</span>
              <span class="cart-price pull-right">￥6088</span>
            </div>
          </div>
